...
"""Doosan M0609 with a Robotiq 2F-85 gripper."""
...
class DoosanM0609Robotiq(UR5eRobotiq):
    """Six-axis M0609 with the shared physical Robotiq articulation."""
    ...
    def __init__(
        self,
        prim_path: str = "/World/DoosanM0609Robotiq",
        name: str = "doosan_m0609_robotiq",
        ...
        if usd_path is None:
            ...
            usd_path = os.path.join(repo_root, "assets/robots/doosan_m0609_robotiq85.usd")
        super().__init__(
            prim_path=prim_path,
            name=name,
            usd_path=usd_path,
    ...
    def motion_config(self) -> dict:
        ...
        return {
            ...
            "urdf_path": os.path.join(package_dir, "doosan_m0609_robotiq85.urdf"),
            "rmpflow_config_path": os.path.join(rmpflow_dir, "doosan_m0609_robotiq_rmpflow_common.yaml"),
        }
